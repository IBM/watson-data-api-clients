 ...
 * PaginatedTermList
 */
public class PaginatedTermList extends PaginatedList {

    private List<Term> resources = null;

    public PaginatedTermList resources(List<Term> resources) {
        this.resources = resources;
        return this;
    }

    public PaginatedTermList addResourcesItem(Term resourcesItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaginatedTermList paginatedArtifactList = (PaginatedTermList)o;
    ...
    public String toString() {
        ...
        sb.append("class PaginatedTermList {\n");
        super.toString(sb);

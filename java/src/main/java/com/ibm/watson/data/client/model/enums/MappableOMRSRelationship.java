...
/**
 * Mappable OMRS relationships.
 **/
public enum MappableOMRSRelationship {
    ...
    MappableOMRSRelationship(String value) { this.value = value; }
    ...
    @JsonCreator
    public static MappableOMRSRelationship fromValue(String value) {
        for (MappableOMRSRelationship b : MappableOMRSRelationship.values()) {

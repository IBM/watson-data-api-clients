...
/**
 * ClassificationRelationshipsRequest
 */
public class ClassificationRelationshipsRequest {
    ...
    public ClassificationRelationshipsRequest parentCategory(NewRelationship parentCategory) {
    ...
    public ClassificationRelationshipsRequest categories(List<NewRelationship> categories) {
        this.categories = categories;
        return this;
    }

    public ClassificationRelationshipsRequest addCategoriesItem(NewRelationship categoriesItem) {
    ...
    public ClassificationRelationshipsRequest isATypeOfClassification(NewRelationship isATypeOfClassification) {
    ...
    public ClassificationRelationshipsRequest hasTypesClassifications(List<NewRelationship> hasTypesClassifications) {
        this.hasTypesClassifications = hasTypesClassifications;
        return this;
    }

    public ClassificationRelationshipsRequest addHasTypesClassificationsItem(NewRelationship hasTypesClassificationsItem) {
    ...
    public ClassificationRelationshipsRequest terms(List<NewRelationship> terms) {
        this.terms = terms;
        return this;
    }

    public ClassificationRelationshipsRequest addTermsItem(NewRelationship termsItem) {
        if (this.terms == null) {
    ...
    public ClassificationRelationshipsRequest dataClasses(List<NewRelationship> dataClasses) {
        this.dataClasses = dataClasses;
        return this;
    }

    public ClassificationRelationshipsRequest addDataClassesItem(NewRelationship dataClassesItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClassificationRelationshipsRequest classificationRelationshipsRequest = (ClassificationRelationshipsRequest)o;
        return Objects.equals(this.parentCategory, classificationRelationshipsRequest.parentCategory) &&
                Objects.equals(this.categories, classificationRelationshipsRequest.categories) &&
                Objects.equals(this.isATypeOfClassification, classificationRelationshipsRequest.isATypeOfClassification) &&
                Objects.equals(this.hasTypesClassifications, classificationRelationshipsRequest.hasTypesClassifications) &&
                Objects.equals(this.terms, classificationRelationshipsRequest.terms) &&
                Objects.equals(this.dataClasses, classificationRelationshipsRequest.dataClasses);
    }

    @Override
    public int hashCode() {
        return Objects.hash(parentCategory, categories, isATypeOfClassification,
    ...
    public String toString() {
        ...
        sb.append("class ClassificationRelationshipsRequest {\n");

...
public class ColumnInfoEntitySerializer extends StdSerializer<ColumnInfoEntity> {
    ...
    public ColumnInfoEntitySerializer() {
        super(ColumnInfoEntity.class);
    }
     ...
     */
    @Override
    public void serialize(ColumnInfoEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException, JsonProcessingException {
